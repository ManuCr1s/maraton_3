...
class RegisterController extends Controller
{
    ...
    public function inscription(){
        $register = new Register;
        $register = Register::Join('levels', 'registers.id_level', '=', 'levels.id_level')
        ->selectRaw('registers.number_doc,registers.id_level,registers.name,registers.lastname,levels.name_level,registers.phone,registers.number_ins,registers.born')
        ->where('registers.number', '=', null)
        ->where('registers.status', '=', 'true')
        ->get();
        return datatables()->of($register)->toJson();
