<div class="table-responsive">
    <table class="table table-sm">
        <thead>
            <tr>
            <th scope="col"></th>
            <th scope="col"><h6 class="text-secondary font-weight-bold">Nombre Categoria</h6></th>
            <th scope="col"><h6 class="text-secondary font-weight-bold">Codigo</h6></th>
            <th scope="col"><h6 class="text-secondary font-weight-bold">Cantidad</h6></th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
                ...
                <td id="tot" class="text-secondary font-weight-bold"></td>
            </tr>
        </tbody>
    </table>
</div>
